...
const TESTIMONIALS = [
  ...
  { name: 'Kavitha & Ramana Murthy', child: 'Parents of twins in Class IV & IX', img: 'https://i.pravatar.cc/80?img=48', stars: 5, text: 'We have two children at very different stages and the school handles both brilliantly. Our younger one loves the playful, activity-based learning, and our older son is thriving with the challenging CBSE curriculum. The school truly caters to every age group.' },
];
