...
export default function Admissions() {
  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit">
      <Helmet>
        <title>Admissions 2026-27 | Akshara High School</title>
        <meta name="description" content="Apply for admission to Akshara High School for the 2026-27 academic year. Online application form, spot admissions, and easy status tracking." />
      </Helmet>
          ...
          <div className="admissions__layout">
            ...
            <div className="admissions__main">
              {success ? (
                <div className="admissions__success">
                  ...
                  <p>Thank you for choosing Akshara High School. Your application has been received.</p>
            ...
            <div className="admissions__sidebar">
              ...
              <div className="admissions__sidebar-card" style={{ background: 'var(--navy)', borderColor: 'var(--navy)' }}>
                ...
                <a href="mailto:aksharaschoolkhankapur@gmail.com" className="btn btn-secondary btn-sm" style={{ width: '100%', justifyContent: 'center' }}>Email Us</a>
              </div>
